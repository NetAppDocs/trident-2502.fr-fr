...
| `autosupportImage` | Image conteneur pour la télémétrie AutoSupport | `"netapp/trident-autosupport:25.02"` 
...
| `tridentImage` | Image Trident à installer | `"netapp/trident:25.02"` 
